...
async def chat_page():
    ...
    # get all custom fields from netbox to prompt custom field
    ...
    # get netbox_prompt_get_objects from MCP
    netbox_prompt_get_objects = await client.get_prompt("netbox", "netbox_prompt_get_objects")
    ...
    # get netbox_prompt_get_changelogs from MCP
    netbox_prompt_get_changelogs = await client.get_prompt("netbox", "netbox_prompt_get_changelogs")
    ...
    prompt_netbox_get_objects = netbox_prompt_get_objects[0].content
    prompt_netbox_changelogs = netbox_prompt_get_changelogs[0].content
    # create agent
    agent = create_react_agent(
        model=llm_model,
        tools=tools,
        prompt= prompt_custom_field + prompt_netbox_str + prompt_checkmk_str + prompt_netbox_count_objects + prompt_netbox_get_objects + prompt_netbox_changelogs,
    )
